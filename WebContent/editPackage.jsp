...
<div id="wrapper">
 ...
 <a href="addPackagePage.jsp">Add</a>
...
PreparedStatement stmt=con.prepareStatement("select * from package where id=?");
stmt.setInt(1,id);
...
<form action="updatePackage.jsp" method="get" name="packageForm" onsubmit="return validatePackageForm(this);">
...
<td><input name="place" type="text" size="20" maxlength="20" value="<%=place %>" class="style1"/>
</td>
</tr>
<tr>
<td>Description
</td>
<td><textarea name="description" cols="50" rows="10" maxlength="500" class="style1"><%=description %></textarea>
</td>
</tr>
<tr>
<td>From
</td>
<td><input name="dateFrom" type="date"  size="10" maxlength="10" value="<%=dateFrom %>" class="style1"/>
</td>
</tr>
<tr>
<td>To
</td>
<td><input name="dateTo" type="date"  size="10" maxlength="10" value="<%=dateTo %>" class="style1"/>
</td>
</tr>
<tr>
<td>Fare
</td>
<td><input name="fare" type="number" max="1000000" min="1000" value="<%=fare %>" class="style1"/>
</td>
</tr>
<tr>
<td><input name="submit" type="submit" value="Update" class="style1"/>
</td>
</tr>
</table>
</form>
