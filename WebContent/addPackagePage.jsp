...
<form action="addPackage.jsp" method="get" name="packageForm" onsubmit="return validatePackageForm(this);">
<table class="style1">
<caption>
<h3>Add Package</h3>
</caption>
...
<td><input name="place" type="text" size="20" maxlength="20" class="style1"/>
</td>
</tr>
<tr>
<td>Description
</td>
<td><textarea name="description" cols="50" rows="10" maxlength="500" class="style1"></textarea>
</td>
</tr>
<tr>
<td>From
</td>
<td><input name="dateFrom" type="date"  size="10" maxlength="10" class="style1"/>
</td>
</tr>
<tr>
<td>To
</td>
<td><input name="dateTo" type="date"  size="10" maxlength="10" class="style1"/>
</td>
</tr>
<tr>
<td>Fare
</td>
<td><input name="fare" type="number" max="1000000" min="1000" class="style1"/>
</td>
</tr>
<tr>
