  ...
  <div id="right">
    <div id="nav">
      ...
      <% if(session.getAttribute("passengerId")!=null){ %>
        ...
        <%} %>
        <li class="selected"><a href="adminLoginPage.jsp">Admin Login </a></li>
      </ul>
    </div>
    <div id="body">
      <div id="body-top">
...
<form action="adminLogin.jsp" method="get" name="adminLoginForm" onsubmit="return validateAdminLoginForm(this);">
<table class="style1">
<caption>
<h3>
Admin Login
