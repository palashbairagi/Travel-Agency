...
<form action="addPassenger.jsp" method="get" name="passengerForm" onsubmit="return validatePassengerForm(this);">
<table class="style1">
<caption>
...
<td><input name="emailId" type="email" size="50" maxlength="50" class="style1"/>
</td>
</tr>
<tr>
<td>Password
...
<td><textarea name="address" cols="25" rows="4" maxlength="100" class="style1"></textarea>
</td>
</tr>
<tr>
<td>Contact Number
</td>
<td><input name="contactNumber" type="text" size="20" maxlength="10" class="style1"/>
</td>
</tr>
<tr>
<td><input name="submit" type="submit" value="Register" class="style1"/>
</td>
<td>
